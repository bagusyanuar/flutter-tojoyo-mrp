...
class RecipeDetailAddPage extends StatefulWidget {
  const RecipeDetailAddPage({Key? key}) : super(key: key);

  @override
  State<RecipeDetailAddPage> createState() => _RecipeDetailAddPageState();
}

class _RecipeDetailAddPageState extends State<RecipeDetailAddPage> {
  ...
  void _eventAdd() async {
    if (selectedMaterial != null) {
      ...
      RecipeMutateResponse recipeMutateResponse = await addRecipe(id, data);
      if (!recipeMutateResponse.error) {
        _textQtyController.text = '';
        setState(() {
          isLoading = false;
